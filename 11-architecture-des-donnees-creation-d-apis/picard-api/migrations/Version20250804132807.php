 ...
 */
final class Version20250804132807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD quantity INT NOT NULL DEFAULT 1');
        $this->addSql('ALTER TABLE product ADD expiration_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
